...
function PageHelmet({
    ...
    const metaDescription = description || metadata?.description || 'A modern web application template';
    const metaImage = image || metadata?.image || '/logo.png';
    const metaKeywords = keywords || metadata?.keywords || ['react', 'application'];
    const metaCanonical = canonicalUrl || metadata?.canonicalUrl || window.location.href;
